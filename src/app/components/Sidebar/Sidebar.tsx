          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold text-primary-800 bg-primary-100 rounded-full">
                  6
                </span>
              </a>
            </li>
        ...
        <div className="absolute bottom-0 left-0 justify-center px-4 pb-4 w-full" sidebar-bottom-menu>
          <div id="alert-update" className="p-4 mb-3 bg-gray-50 rounded-lg" role="alert">
            <div className="flex justify-between items-center mb-3">
              <span className="bg-purple-100 text-purple-600 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">New update</span>
              <button
                type="button"
            ...
            <div className="mb-3 text-sm text-gray-700">A new system update is available today.</div>
            <a href="#" className="inline-flex items-center text-sm font-medium text-purple-600 hover:underline">
              Update now
